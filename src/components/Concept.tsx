  ...
  return (
    <section id="concept" className="py-24 px-4 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-gold text-xs tracking-luxury font-body uppercase">{t("concept.label")}</span>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <p className="text-foreground/80 font-body leading-relaxed">{renderP1()}</p>
            <p className="text-foreground/70 font-body leading-relaxed">{t("concept.p2")}</p>
            <p className="text-foreground/70 font-body leading-relaxed">{t("concept.p3")}</p>

            <div className="pt-6 border-t border-border">
              <p className="text-foreground/60 font-body text-sm tracking-wide">{t("concept.priceLabel")}</p>
