      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-foreground/60 font-body text-sm leading-relaxed max-w-md whitespace-pre-line">
              {t("footer.desc")}
            </p>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading text-lg mb-6 italic">{t("footer.contactTitle")}</h4>
